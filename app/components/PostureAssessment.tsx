          ...
          <div className="pa-result-left">
            ...
            <div className="pa-total-score">
              <div className="pa-score-circle" style={{
                background: `conic-gradient(${getPostureGrade(result.metrics.overallScore).color} ${result.metrics.overallScore * 3.6}deg, #e5e7eb ${result.metrics.overallScore * 3.6}deg)`
              }}>
